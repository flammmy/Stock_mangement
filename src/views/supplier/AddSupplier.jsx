            ...
            <Card.Body className="p-5">
              <Form onSubmit={handleSubmit}>
                <Row>
                  {/* First Column */}
                  <Col md={6}>
                    <FormField icon={FaUser} label="Supplier Name" name="name" value={formData.name} onChange={handleChange} />
                    <FormField icon={FaIdCard} label="GST Number" name="gst_no" value={formData.gst_no} onChange={handleChange} />

                    <FormField icon={FaIdCard} label="CIN Number" name="cin_no" value={formData.cin_no} onChange={handleChange} />

                    <FormField icon={FaIdCard} label="PAN Number" name="pan_no" value={formData.pan_no} onChange={handleChange} />
                    <FormField icon={FaPhone} label="Telephone Number" name="tel_no" value={formData.tel_no} onChange={handleChange} />
                  ...
                  {/* Second Column */}
                  <Col md={6}>
                    <FormField icon={FaIdCard} label="MSME Number" name="msme_no" value={formData.msme_no} onChange={handleChange} />
                    ...
                    <FormField icon={FaMapMarkerAlt} label="Area" name="area" value={formData.area} onChange={handleChange} />

                    {/* Contact Details */}

                    <FormField icon={FaEnvelope} label="Email" type="email" name="email" value={formData.email} onChange={handleChange} />
